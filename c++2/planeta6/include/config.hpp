...
// Stable canopy clumps
inline constexpr int   tree_canopy_clump_count_min = 7;
inline constexpr int   tree_canopy_clump_count_max = 13;
inline constexpr float tree_canopy_clump_radius_min = 0.16f;
inline constexpr float tree_canopy_clump_radius_max = 0.42f;
inline constexpr float tree_canopy_clump_spread = 0.72f;
inline constexpr float tree_canopy_clump_upward_bias = 0.18f;
inline constexpr float tree_canopy_clump_inner_fill = 0.32f;
