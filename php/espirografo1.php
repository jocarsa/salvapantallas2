  ...
  <style>
    ...
    <script>
      ...
      function bucle(){
        ...
        if(
          Math.abs(anchura/2+Math.cos(angulo1)*radio1+Math.cos(angulo2)*radio2 - iniciox) < 2
          &&
          Math.abs(altura/2+Math.sin(angulo1)*radio1+Math.sin(angulo2)*radio2 - inicioy) < 2
          &&
          contador > 1000
        ){
          enviarCanvas();
